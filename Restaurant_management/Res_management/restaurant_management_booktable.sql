...
CREATE TABLE `booktable` (
  ...
  `dateBookTable` datetime DEFAULT NULL,
  PRIMARY KEY (`idBook`),
  KEY `idTable` (`idTable`),
  KEY `idCustomer` (`idCustomer`),
  CONSTRAINT `booktable_ibfk_1` FOREIGN KEY (`idTable`) REFERENCES `tables` (`idTable`),
  CONSTRAINT `booktable_ibfk_2` FOREIGN KEY (`idCustomer`) REFERENCES `customers` (`idCustomer`)
...
-- Dump completed on 2021-07-14  9:11:38
