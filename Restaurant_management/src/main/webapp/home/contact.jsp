<%@include file="/layoutHome/lab.jsp"%>
<!DOCTYPE html>
<html>

<head>
    <%@include file="/layoutHome/head.jsp"%>
</head>
...
<div class="container">
    <!-- Top box -->
    <!-- Logo & Site Name -->
    <%@include file="/layoutHome/Logo-SiteName.jsp"%>
    ...
    <main>
        ...
        <div class="tm-container-inner-2 tm-map-section">
            <div class="row">
                <div class="col-12">
                    <div class="tm-map">
                        <iframe src="https://www.google.com/maps/embed?pb=!1m23!1m12!1m3!1d4420.583477791394!2d107.58945012105357!3d16.46658937218345!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!4m8!3e6!4m0!4m5!1s0x3141a13b8b0f80fb%3A0x475d6ab005f24b52!2stake%20restaurant%20hue!3m2!1d16.46576!2d107.59199869999999!5e0!3m2!1sen!2s!4v1628060418685!5m2!1sen!2s" width="400" height="300" style="border:0;" allowfullscreen="" loading="lazy"></iframe>
                    </div>
                </div>
            </div>
        </div>
   ...
   <%@include file="/layoutHome/footer.jsp"%>>
</div>
<%@include file="/layoutHome/scrip.jsp"%>
<script>
