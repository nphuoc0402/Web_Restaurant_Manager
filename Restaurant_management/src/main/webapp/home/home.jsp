...
<div class="container">
    ...
    <main>
        <header class="row tm-welcome-section">
            <h2 class="col-12 text-center tm-section-title">Welcome to Ta.ke Japanese Restaurant</h2>
        ...
        <div class="tm-paging-links">
            <nav>
                <ul>
<%--                    <c:forEach items="${cataloglist}" var="cal">--%>
...
<%--                    </c:forEach>--%>
        ...
        <div class="row tm-gallery">
            ...
            <div id="tm-gallery-page-pizza" class="tm-gallery-page">
                <c:if test="${cataloglist.get(1).getCal_id() == 0}">
                    <c:forEach items="${products}" var="products">
                        <article class="col-lg-3 col-md-4 col-sm-6 col-12 tm-gallery-item">
                            <figure>
                                <img style="width: 250px; height: 250px" src="${products.getP_image()}" alt="Image" class="img-fluid tm-gallery-img" />
                                <figcaption>
                                    <h4 class="tm-gallery-title">${products.getP_name()}</h4>
                                    <p class="tm-gallery-description">${products.getP_description()}</p>
                                    <p class="tm-gallery-price"><fmt:formatNumber value="${products.getP_price()}" type="currency" currencySymbol="$" ></fmt:formatNumber></p>
                                </figcaption>
                            </figure>
                        </article>
                    </c:forEach>
